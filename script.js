...
const testNum = (number) => {
    return new Promise((resolve, reject) => {
        if (number < 10) {
            ...
            reject("number is bigger then 10");
        }
    })
};

testNum(8)
    .then(bigger => console.log(bigger))
    .catch(less => console.log(less));
...
words and capitalize them, and then the second function, sortWords(), will sort the words in alphabetical order. If the array contains anything but strings, 
